...
| `desktop.calendar-notifier.calendarUrl`       | `string` | `"https://accounts.google.com/AccountChooser?continue=..."`                        | URL opened by "Open Calendar". Default routes via Google's AccountChooser; set to e.g. `.../u/1/r/day` to pin account  |
